...
export const USER_SUPPLIED_SEO_KEYWORDS = [
  "Alliance Insurance Group benefits",
  "Alliance Insurance Group benefits login",
  "Alliance Insurance Group login",
  "Alliance Insurance Group employee benefits",
  "Alliance Insurance Group participant login",
  "Alliance Insurance Group benefits portal",
  "Alliance Insurance Group WealthCare",
  "Alliance Insurance Group WealthCare login",
  "Alliance Insurance Group HSA",
  "Alliance Insurance Group HSA login",
  "Alliance Insurance Group HSA account",
  "Alliance Insurance Group HSA account login",
  "Alliance Insurance Group Health Savings Account",
  "Alliance Insurance Group Health Savings Account login",
  "Alliance Insurance Group HSA participant login",
  "Alliance Insurance Group FSA",
  "Alliance Insurance Group FSA login",
  "Alliance Insurance Group FSA account",
  "Alliance Insurance Group FSA account login",
  "Alliance Insurance Group Flexible Spending Account",
  "Alliance Insurance Group Flexible Spending Account login",
  "Alliance Insurance Group FSA reimbursement",
  "Alliance Insurance Group FSA claims",
  "Alliance Insurance Group HRA",
  "Alliance Insurance Group HRA login",
  "Alliance Insurance Group HRA account",
  "Alliance Insurance Group HRA account login",
  "Alliance Insurance Group Health Reimbursement Account",
  "Alliance Insurance Group Health Reimbursement Account login",
  "Alliance Insurance Group HRA reimbursement",
  "Alliance Insurance Group dependent care FSA",
  "Alliance Insurance Group dependent care FSA login",
  "Alliance Insurance Group DCFSA",
  "Alliance Insurance Group limited purpose FSA",
  "Alliance Insurance Group LPFSA",
  "Alliance Insurance Group commuter benefits",
  "Alliance Insurance Group commuter benefits login",
  "WealthCare Portal Alliance Insurance Group",
  "WealthCare Portal Alliance Insurance Group login",
  "Alliance Insurance Group participant portal",
  "Alliance Insurance Group account login",
  "Alliance Insurance Group benefits account",
  "Alliance Insurance Group reimbursement account",
  "Alliance Insurance Group benefits card",
  "Alliance Insurance Group claims",
  "Alliance Insurance Group benefits reimbursement",
  "aig.wealthcareportal.com",
  "aig.wealthcareportal.com login",
  "aig WealthCare Portal login",
  "AIG WealthCare Portal",
  "AIG WealthCare login",
  "AIG benefits portal login",
  "WealthCare HSA login",
  "WealthCare FSA login",
  "WealthCare HRA login",
  "WealthCare participant login",
  "WealthCare benefits account login",
  "HSA participant login",
  "FSA participant login",
  "HRA participant login",
  "benefits account login",
  "health benefits reimbursement login",
] as const;

export const CRAWLER_RELATED_SEARCHES = [
  "Alliance Insurance Group benefits login",
  "Alliance Insurance Group participant portal",
  "Alliance Insurance Group HSA login",
  "Alliance Insurance Group FSA reimbursement",
